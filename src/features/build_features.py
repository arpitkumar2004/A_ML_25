...
class FeatureBuilder:
    ...
    def _derive_numeric_cols(df: pd.DataFrame, text_col: str) -> List[str]:
        preferred = [
            ...
            "parsed_volume_log1p",
            "parsed_count_log1p",
            "parsed_weight_per_unit",
            "parsed_volume_per_unit",
            "parsed_interaction_weight_count",
            "parsed_mass_density",
            "parsed_weight_power_075",
            "parsed_volume_power_075",
            "parsed_count_power_075",
            "spec_is_organic",
            "spec_is_premium",
            "spec_is_bulk_value",
            "spec_is_sample_travel",
            "spec_is_multipack",
            "unit_domain_weight",
            "unit_domain_volume",
            "unit_domain_count",
